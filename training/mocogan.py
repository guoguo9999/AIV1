...
from src.training.networks_b import Discriminator as ImageDiscriminator
...
class Discriminator(nn.Module):
    ...
    def forward(self, img: Tensor, c: Tensor, t: Tensor, **img_discr_kwargs) -> Tuple[Tensor, "None"]:
        """
        - img的形状为[batch_size * num_frames_per_video, c, h, w]
        - c的形状为[batch_size, c_dim]
        - t的形状为[batch_size, num_frames_per_video]
        """
